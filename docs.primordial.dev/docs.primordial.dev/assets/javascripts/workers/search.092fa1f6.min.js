(() => {
    ...
    var G = (t, e, r) => e in t ? B(t, e, {
        ...
        X = (t, e) => {
            for (var r in e || (e = {})) J.call(e, r) && G(t, r, e[r]);
            if (Y)
                for (var r of Y(e)) ve.call(e, r) && G(t, r, e[r]);
            return t
        };
    var xe = t => B(t, "__esModule", {
        value: !0
    });
    var Z = (t, e) => () => (e || t((e = {
        exports: {}
    ...
    var Se = (t, e, r, n) => {
            if (e && typeof e == "object" || typeof e == "function")
                for (let i of ye(e)) !J.call(t, i) && (r || i !== "default") && B(t, i, {
                    get: () => e[i],
                    enumerable: !(n = ge(e, i)) || n.enumerable
                });
            return t
        },
        U = (t, e) => Se(xe(B(t != null ? de(me(t)) : {}, "default", !e && t && t.__esModule ? {
            get: () => t.default,
            enumerable: !0
        } : {
            value: t,
    ...
    var te = Z((K, ee) => {
        ...
        (function() {
            ...
            t.tokenizer = function(e, r) {
                ...
                if (Array.isArray(e)) return e.map(function(y) {
                    return new t.Token(t.utils.asString(y).toLowerCase(), t.utils.clone(r))
                });
                for (var n = e.toString().toLowerCase(), i = n.length, s = [], o = 0, a = 0; o <= i; o++) {
                    ...
                    if (u.match(t.tokenizer.separator) || o == i) {
                        if (c > 0) {
                            ...
                            h.position = [a, c], h.index = s.length, s.push(new t.Token(n.slice(a, o), h))
                        }
                        a = o + 1
                    }
                }
...
`, e)
            ...
            t.Vector = function(e) {
                ...
                for (var r = 0, n = this.elements, i = e.elements, s = n.length, o = i.length, a = 0, u = 0, c = 0, h = 0; c < s && h < o;) a = n[c], u = i[h], a < u ? c += 2 : a > u ? h += 2 : a == u && (r += n[c + 1] * i[h + 1], c += 2, h += 2);
                return r
            ...
            t.stemmer = function() {
                var e = {
                    ...
                    D = function(l) {
                        ...
                        if (E = l.substr(0, 1), E == "y" && (l = E.toUpperCase() + l.substr(1)), f = Q, x = p, f.test(l) ? l = l.replace(f, "$1$2") : x.test(l) && (l = l.replace(x, "$1$2")), f = d, x = w, f.test(l)) {
                            var S = f.exec(l);
                            f = y, f.test(S[1]) && (f = L, l = l.replace(f, ""))
                        } else if (x.test(l)) {
                            var S = x.exec(l);
                            m = S[1], x = v, x.test(m) && (l = m, x = k, R = I, _ = M, x.test(l) ? l = l + "e" : R.test(l) ? (f = L, l = l.replace(f, "")) : _.test(l) && (l = l + "e"))
                        }
                        if (f = F, f.test(l)) {
                            var S = f.exec(l);
                            m = S[1], l = m + "i"
                        ...
                        if (f = j, f.test(l)) {
                            var S = f.exec(l);
                            m = S[1], P = S[2], f = y, f.test(m) && (l = m + e[P])
                        }
                        if (f = A, f.test(l)) {
                            var S = f.exec(l);
                            m = S[1], P = S[2], f = y, f.test(m) && (l = m + r[P])
                        }
                        if (f = C, x = N, f.test(l)) {
                            var S = f.exec(l);
                            m = S[1], f = g, f.test(m) && (l = m)
                        } else if (x.test(l)) {
                            var S = x.exec(l);
                        ...
                        if (f = T, f.test(l)) {
                            var S = f.exec(l);
                            m = S[1], f = g, x = b, R = V, (f.test(m) || x.test(m) && !R.test(m)) && (l = m)
                        }
                        return f = $, x = g, f.test(l) && x.test(l) && (f = L, l = l.replace(f, "")), E == "y" && (l = E.toLowerCase() + l.substr(1)), l
                    };
                return function(O) {
                    return O.update(D)
                }
                    ...
                    if (s.editsRemaining != 0) {
                        ...
                        if (s.str.length > 1) {
                            var h = s.str.charAt(0),
                                y = s.str.charAt(1),
                                g;
                            y in s.node.edges ? g = s.node.edges[y] : (g = new t.TokenSet, s.node.edges[y] = g), s.str.length == 1 && (g.final = !0), i.push({
                                node: g,
                                editsRemaining: s.editsRemaining - 1,
                                str: h + s.str.slice(2)
                            })
                        ...
                        for (var h = s[c], y = 0; y < u; y++) {
                            ...
                            if (g == h || h == "*") {
                                var b = n.node.edges[g],
                                    ...
                                    Q = b.final && v.final,
                                    p = void 0;
                                g in n.output.edges ? (p = n.output.edges[g], p.final = p.final || Q) : (p = new t.TokenSet, p.final = Q, n.output.edges[g] = p), i.push({
                                    qNode: v,
                                    output: p,
                                    node: b
                                })
            ...
            t.Index = function(e) {
                ...
                for (var u = 0; u < r.clauses.length; u++) {
                    var c = r.clauses[u],
                        h = null,
                        y = t.Set.empty;
                    c.usePipeline ? h = this.pipeline.runString(c.term, {
                        fields: c.fields
                    }) : h = [c.term];
                    for (var g = 0; g < h.length; g++) {
                        ...
                        for (var w = 0; w < Q.length; w++)
                            for (var L = Q[w], k = this.invertedIndex[L], I = k._index, p = 0; p < c.fields.length; p++) {
                                var d = c.fields[p],
                                    M = k[d],
                                    F = Object.keys(M),
                                    j = L + "/" + d,
                                    A = new t.Set(F);
                                if (c.presence == t.Query.presence.REQUIRED && (y = y.union(A), o[d] === void 0 && (o[d] = t.Set.complete)), c.presence == t.Query.presence.PROHIBITED) {
                                    a[d] === void 0 && (a[d] = t.Set.empty), a[d] = a[d].union(A);
                                    continue
                                }
                                if (i[d].upsert(I, c.boost, function(fe, pe) {
                                        return fe + pe
                                    }), !s[j]) {
                                    for (var C = 0; C < F.length; C++) {
                                        var N = F[C],
                                            T = new t.FieldRef(N, d),
                                            $ = M[N],
                                            V;
                                        (V = n[T]) === void 0 ? n[T] = new t.MatchData(L, d, $) : V.add(L, d, $)
                                    }
                                    s[j] = !0
                                }
                            }
                ...
                for (var D = t.Set.complete, O = t.Set.empty, u = 0; u < this.fields.length; u++) {
                    var d = this.fields[u];
                ...
                for (var u = 0; u < l.length; u++) {
                    ...
                    if (!!D.contains(f) && !O.contains(f)) {
                        var x = this.fieldVectors[E],
                            ...
                            _;
                        if ((_ = P[f]) !== void 0) _.score += R, _.matchData.combine(n[E]);
                        else {
                            var S = {
                                ref: f,
                                score: R,
                ...
                return m.sort(function(le, he) {
                    return he.score - le.score
                })
            ...
            t.Builder = function() {
                    ...
                    for (var s = 0; s < i.length; s++) {
                        ...
                        this.fieldTermFrequencies[y] = g, this.fieldLengths[y] = 0, this.fieldLengths[y] += h.length;
                        for (var b = 0; b < h.length; b++) {
                            var v = h[b];
                            if (g[v] == null && (g[v] = 0), g[v] += 1, this.invertedIndex[v] == null) {
                                var Q = Object.create(null);
                                Q._index = this.termIndex, this.termIndex += 1;
                                for (var p = 0; p < i.length; p++) Q[i[p]] = Object.create(null);
                                this.invertedIndex[v] = Q
                            }
                            this.invertedIndex[v][o][n] == null && (this.invertedIndex[v][o][n] = Object.create(null));
                            for (var d = 0; d < this.metadataWhitelist.length; d++) {
                                var w = this.metadataWhitelist[d],
                                    L = v.metadata[w];
                                this.invertedIndex[v][o][n][w] == null && (this.invertedIndex[v][o][n][w] = []), this.invertedIndex[v][o][n][w].push(L)
                            }
                        }
                    }
                    ...
                    for (var e = {}, r = Object.keys(this.fieldTermFrequencies), n = r.length, i = Object.create(null), s = 0; s < n; s++) {
                        for (var o = t.FieldRef.fromString(r[s]), a = o.fieldName, u = this.fieldLengths[o], c = new t.Vector, h = this.fieldTermFrequencies[o], y = Object.keys(h), g = y.length, b = this._fields[a].boost || 1, v = this._documents[o.docRef].boost || 1, Q = 0; Q < g; Q++) {
                            var p = y[Q],
                                d = h[p],
                                w = this.invertedIndex[p]._index,
                                L, k, I;
                            i[p] === void 0 ? (L = t.idf(this.invertedIndex[p], this.documentCount), i[p] = L) : L = i[p], k = L * ((this._k1 + 1) * d) / (this._k1 * (1 - this._b + this._b * (u / this.averageFieldLength[a])) + d), k *= b, k *= v, I = Math.round(k * 1e3) / 1e3, c.insert(w, I)
                        }
                        e[o] = c
                    }
                    this.fieldVectors = e
                    ...
                    for (;;) {
                        ...
                        if (r == "+" && e.width() === 1 || r == "-" && e.width() === 1) return e.emit(t.QueryLexer.PRESENCE), t.QueryLexer.lexText;
    ...
    typeof Element != "undefined" && (Element.prototype.scrollTo || (Element.prototype.scrollTo = function(t, e) {
        ...
        if (e) {
            ...
            for (let r = t.length - 1; r >= 0; r--) {
                let n = t[r];
                typeof n != "object" ? n = document.createTextNode(n) : n.parentNode && n.parentNode.removeChild(n), r ? e.insertBefore(this.previousSibling, n) : e.replaceChild(n, this)
            }
        }
    }));
    var ne = U(W());
    ...
    function ie(t) {
        let e = new Map,
            r = new Set;
        for (let n of t) {
            let [i, s] = n.location.split("#"), o = n.location, a = n.title, u = (0, ne.default)(n.text).replace(/\s+(?=[,.:;!?])/g, "").replace(/\s+/g, " ");
            if (s) {
                let c = e.get(i);
                r.has(c) ? e.set(o, {
                    location: o,
    ...
    function oe(t, e) {
        ...
        return i => {
            ...
            let s = new RegExp(`(^|${t.separator})(${i.replace(/[|\\{}()[\]^$+*?.-]/g,"\\$&").replace(r,"|")})`, "img");
            return o => (e ? (0, se.default)(o) : o).replace(s, n).replace(/<\/mark>(\s+)<mark[^>]*>/img, "$1")
        }
    }
    ...
    function ue(t, e) {
        ...
        for (let s of r)((i = lunr.stopWordFilter) == null ? void 0 : i.call(lunr, s.term)) && (n[s.term] = !1);
        return n
    }
    ...
    var H = class {
        constructor({
            ...
            this.options = n, this.documents = ie(r), this.highlight = oe(e, !1), lunr.tokenizer.separator = new RegExp(e.separator), this.index = lunr(function() {
                e.lang.length === 1 && e.lang[0] !== "en" ? this.use(lunr[e.lang[0]]) : e.lang.length > 1 && this.use(lunr.multiLanguage(...e.lang));
                let i = Le(["trimmer", "stopWordFilter", "stemmer"], n.pipeline);
                for (let s of e.lang.map(o => o === "en" ? lunr : lunr[o]))
                    for (let o of i) this.pipeline.remove(s[o]), this.searchPipeline.remove(s[o]);
                this.ref("location"), this.field("title", {
                    boost: 1e3
                }), this.field("text");
                for (let s of r) this.add(s)
            })
        }
        search(e) {
            if (e) try {
                let r = this.highlight(e),
                    n = ae(e).filter(o => o.presence !== lunr.Query.presence.PROHIBITED),
                    i = this.index.search(`${e}*`).reduce((o, {
                        ref: a,
                        score: u,
                        matchData: c
                    }) => {
                        ...
                        if (typeof h != "undefined") {
                            let {
                                ...
                                text: b,
                                parent: v
                            } = h, Q = ue(n, Object.keys(c.metadata)), p = +!v + +Object.values(Q).every(d => d);
                            o.push({
                                location: y,
                                title: r(g),
                                text: r(b),
                        ...
                        return o
                    }, []).sort((o, a) => a.score - o.score).reduce((o, a) => {
    ...
    function Ee(t) {
        return z(this, null, function*() {
            switch (t.type) {
                case 0:
                    return yield we(t.data.config), q = new H(t.data), {
                        type: 1
                    };
                case 2:
                    return {
                        type: 3,
                        data: q ? q.search(t.data) : {
                            items: []
                        }
                    };
                default:
    ...
    self.lunr = ce.default;
    addEventListener("message", t => z(void 0, null, function*() {
        postMessage(yield Ee(t.data))
    }));
})();
